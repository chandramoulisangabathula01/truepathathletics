    ...
    <section ref={containerRef} className="py-16 sm:py-24 md:py-28 lg:py-32 bg-background-light/5">
      ...
      <div className="flex justify-center px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Play Button */}
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-accent-lime rounded-full flex items-center justify-center shadow-[0_0_30px_var(--accent-glow)] transition-transform group-hover:scale-110 active:scale-95 duration-500 relative">
              <div className="absolute inset-0 rounded-full border-2 border-accent-lime/30 animate-[ping_2s_cubic-bezier(0,0,0.2,1)_infinite]" />
